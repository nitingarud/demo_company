...
return g(),k
    ...
    var b="alert",d="4.0.0-alpha.5",g="bs.alert",h="."+g,i=".data-api",j=a.fn[b],k=150,l={
...
return a(document).on(l.CLICK_DATA_API,n.DATA_TOGGLE,function(b){
    ...
    if(this.config)for(var b in this.config)this.constructor.Default[b]!==this.config[b]&&(a[b]=this.config[b]);return a
    },j._jQueryInterface=function(b){
    return this.each(function(){
        var c=a(this).data(h),e="object"===("undefined"==typeof b?"undefined":d(b))?b:null;
